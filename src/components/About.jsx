        ...
        <div className="grid md:grid-cols-2 gap-20 items-center">
          <div className="relative group" data-aos="fade-right">
            ...
            <div className="animate-float relative">
              ...
              <div className="relative rounded-[2.5rem] overflow-hidden glass-card shadow-2xl border border-white/5">
                <img src="https://res.cloudinary.com/dpktusyjs/image/upload/q_auto/f_auto/v1776056836/Screenshot_2026-04-10_202949_njx4kq.png" alt="Rani"
          ...
          <div data-aos="fade-left" className="mt-12 md:mt-0 text-center md:text-left">
            ...
            <p className="text-slate-400 mb-8 text-lg leading-relaxed font-medium" data-aos="fade-left" data-aos-delay="200">
              Hello! I'm Rani Patel, a computer science student and <span className="text-white font-bold decoration-secondary/30 decoration-2 underline underline-offset-4">full-stack developer</span> based in India.
