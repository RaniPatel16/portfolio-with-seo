    ...
    <nav className="fixed w-full z-[999999] transition-all duration-300 bg-transparent backdrop-blur-md" id="navbar">
      <div className="container mx-auto px-6 py-4 flex justify-between items-center">
        ...
        <div className="hidden md:flex space-x-8 items-center font-semibold text-sm">
          ...
          <a href="/resume.html" download="Rani_Patel_Resume.html" className="px-6 py-2.5 rounded-full bg-gradient-to-r from-primary to-secondary text-white hover:shadow-[0_0_20px_rgba(99,102,241,0.5)] transition-all duration-300 hover:scale-105 active:scale-95 text-sm font-bold tracking-wide magnetic-btn">
            Download Resume
          </a>
        </div>
      ...
      <div ref={menuRef} className={`${mobileOpen ? 'block' : 'hidden'} md:hidden glass-card border-t border-slate-800/50 bg-dark/95 backdrop-blur-2xl absolute w-full shadow-2xl transition-all duration-500`}
        ...
        <div className="flex flex-col p-8 space-y-6 text-center">
          ...
          <div className="pt-4 border-t border-slate-800/50">
            <a href="/resume.html" download="Rani_Patel_Resume.html" className="w-full inline-block px-8 py-4 rounded-2xl bg-gradient-to-r from-primary to-secondary text-white font-bold text-lg shadow-lg shadow-primary/20">
              Download Resume
            </a>
          </div>
        </div>
