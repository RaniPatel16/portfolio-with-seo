    ...
    <footer className="py-8 border-t border-slate-800/50 bg-slate-900/50 backdrop-blur-sm relative z-10">
      <div className="container mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-4">
        <div className="text-center md:text-left">
          <p className="text-slate-500 font-medium">© 2026 Rani Patel. All rights reserved.</p>
        </div>

        <div className="flex items-center gap-6">
          <a href="https://leetcode.com/u/QGxRFjxdGR/" target="_blank" rel="noreferrer" className="text-slate-400 hover:text-[#FFA116] transition-colors text-sm font-bold">LeetCode</a>
          <a href="https://www.youtube.com/@RaniPatel-l2o" target="_blank" rel="noreferrer" className="text-slate-400 hover:text-[#FF0000] transition-colors text-sm font-bold">YouTube</a>
