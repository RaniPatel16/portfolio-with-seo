    ...
    <section id="contact" className="py-24 relative overflow-hidden bg-transparent">
      <div className="container mx-auto px-6">
        ...
        <div className="max-w-5xl mx-auto" data-aos="fade-up">
          <div className="relative glass-card border border-white/5 bg-slate-900/60 shadow-2xl rounded-[2.5rem] overflow-hidden">
            ...
            <div className="grid md:grid-cols-2 gap-12 relative z-10 p-8 md:p-14">
              {/* Left: Contact Info */}
              <div className="space-y-12">
                ...
                <div className="space-y-6">
                  <div className="flex items-center gap-4 group">
                    ...
                    <div>
                      ...
                      <p className="text-white font-black text-lg">rani.patel@gmail.com</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-4 group">
                ...
                <div className="pt-8 border-t border-slate-800/50">
                  ...
                  <div className="flex gap-4">
                    <a href="https://github.com/RaniPatel16" target="_blank" rel="noreferrer" className="w-12 h-12 rounded-xl bg-slate-900 border border-slate-800 flex items-center justify-center hover:border-primary transition-all group">
                      <GithubIcon className="w-5 h-5 text-slate-400 group-hover:text-white" />
                    </a>
                    <a href="https://www.linkedin.com/in/rani-patel-5aa5a3397" target="_blank" rel="noreferrer" className="w-12 h-12 rounded-xl bg-slate-900 border border-slate-800 flex items-center justify-center hover:border-primary transition-all group">
                      <LinkedinIcon className="w-5 h-5 text-slate-400 group-hover:text-white" />
                    </a>
                    <a href="https://leetcode.com/u/QGxRFjxdGR/" target="_blank" rel="noreferrer" className="w-12 h-12 rounded-xl bg-slate-900 border border-slate-800 flex items-center justify-center hover:border-[#FFA116] transition-all group">
                      <LeetCodeIcon className="w-5 h-5 text-slate-400 group-hover:text-[#FFA116]" />
                    </a>
                    <a href="https://x.com/RaniPatel161206" target="_blank" rel="noreferrer" className="w-12 h-12 rounded-xl bg-slate-900 border border-slate-800 flex items-center justify-center hover:border-primary transition-all group">
