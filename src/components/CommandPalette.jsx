...
const commands = [
  ...
  { section: 'Actions', items: [
    ...
    { icon: <GithubIcon className="w-5 h-5 text-slate-300" />, label: 'View GitHub', action: 'link:https://github.com/RaniPatel16' },
    { icon: <LinkedinIcon className="w-5 h-5 text-blue-400" />, label: 'View LinkedIn', action: 'link:https://www.linkedin.com/in/rani-patel-5aa5a3397' },
  ]},
]
